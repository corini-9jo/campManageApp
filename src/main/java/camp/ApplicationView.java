...
public class ApplicationView {
    ...
    public ApplicationView(StudentManagement studentManagement, ScoreManagement scoreManagement) {
    ...
    private static void displayStudentView() {
        ...
        while (flag) {
            ...
            switch (input) {
                ...
                case 2 -> studentManagement.inquireStudentAll(); // 수강생 목록 조회
    ...
    private static void displayScoreView() {
        ...
        while (flag) {
            ...
            switch (input) {
                ...
                case 2 -> scoreManagement.updateRoundScoreBySubject();
                case 3 -> scoreManagement.inquireScore();
